...
if(isset($credit)&& isset($amount))
{
	...
	if($total_cost >= $amount)
	{
		 ...
		 session_destroy();
		  echo "Order successfully processed. You will be notifyed on your email out your products... You will be locked out by the security of the system... Thanks <a href='index.php'>Click Here</a>";
		  exit;
	}
	else
	{
